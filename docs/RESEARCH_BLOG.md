...
12k, 14k, 16k, 18k, and 20k steps its matched validation loss moved from
**2.41839** to
...
Over the full trajectory the zero-route fraction rose from 79.62% to 88.15%,
attention entropy fell from 2.3844 to 1.8451, residual NMSE rose from 0.01670
to 0.02287, and probability code 2 remained unused.
